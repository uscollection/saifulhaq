...
!(function (e) {
  e.fn.niceSelect = function (s) {
        ...
        "update" == s
          ? this.each(function () {
              var s = e(this),
                ...
                n = i.hasClass("open");
              i.length && (i.remove(), t(s), n && s.next().trigger("click"));
            })
          : "destroy" == s
          ? (this.each(function () {
              var s = e(this),
          ...
          : console.log('Method "' + s + '" does not exist.'),
        this
      );
    function t(s) {
      s.after(
        e("<div></div>")
          ...
          .addClass(s.attr("disabled") ? "disabled" : "")
          .attr("tabindex", s.attr("disabled") ? null : "0")
          .html('<span class="current"></span><ul class="list"></ul>')
      );
      var t = s.next(),
        i = s.find("option"),
        n = s.find("option:selected");
      t.find(".current").html(n.data("display") || n.text()),
        i.each(function (s) {
          var i = e(this),
            n = i.data("display");
          t.find("ul").append(
    ...
    this.hide(),
      ...
      e(document).on("click.nice_select", ".nice-select", function (s) {
        var t = e(this);
      ...
      e(document).on("click.nice_select", function (s) {
        0 === e(s.target).closest(".nice-select").length &&
      ...
      e(document).on("keydown.nice_select", ".nice-select", function (s) {
        var t = e(this),
          i = e(t.find(".focus") || t.find(".list .option.selected"));
        ...
        if (38 == s.keyCode) {
          if (t.hasClass("open")) {
            ...
            l.length > 0 &&
              (t.find(".focus").removeClass("focus"), l.addClass("focus"));
          } else t.trigger("click");
          return !1;
        }
