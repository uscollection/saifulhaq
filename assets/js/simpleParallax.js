  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony default export */ var helpers_isSupportedBrowser =
          isSupportedBrowser;
          ...
          _createClass(Viewport, [
            ...
            },
            {
              ...
              value: function setViewportAll(container) {
                ...
                this.positions.top = container
                  ? container.scrollTop
                  : window.pageYOffset; // if this is a custom container, get the height from the custom container itself
        ...
        /* harmony default export */ var helpers_convertToArray =
          convertToArray;
        ...
        var isImageLoaded = function isImageLoaded(media) {
          ...
          if (
            typeof media.naturalWidth !== "undefined" &&
          ...
          parallax_createClass(ParallaxInstance, [
              ...
              value: function init(asyncInit) {
                ...
                if (this.settings.delay > 0) {
                  ...
                  setTimeout(function () {
                    ...
                    _this2.elementContainer.classList.add(
            ...
            },
            {
              ...
              value: function wrapElement() {
                ...
                var elementToWrap =
                  this.element.closest("picture") || this.element; // create a .simpleParallax wrapper container
            ...
            },
            {
              ...
              value: function getTranslateValue() {
                ...
                ).toFixed(1); // sometime the percentage exceeds 100 or goes below 0
                ...
                this.translateValue = (
                  ...
                  this.rangeMax / 2
                ).toFixed(0); // sometime the same translate value is returned
                // if so we don't do aything
        ...
        function _slicedToArray(arr, i) {
          return (
            ...
            simpleParallax_unsupportedIterableToArray(arr, i) ||
            _nonIterableRest()
          );
        }
        ...
        function simpleParallax_unsupportedIterableToArray(o, minLen) {
          if (!o) return;
          if (typeof o === "string")
            return simpleParallax_arrayLikeToArray(o, minLen);
          var n = Object.prototype.toString.call(o).slice(8, -1);
          if (n === "Object" && o.constructor) n = o.constructor.name;
          if (n === "Map" || n === "Set") return Array.from(o);
          if (
        ...
        var simpleParallax_SimpleParallax = /*#__PURE__*/ (function () {
          function SimpleParallax(elements, options) {
            ...
            if (this.settings.customContainer) {
              var _convertToArray = helpers_convertToArray(
